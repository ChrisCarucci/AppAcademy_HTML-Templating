...
const server = http.createServer((req, res) => {
  ...
  req.on("end", () => {
    ...
    if (req.method === 'POST' && req.url === '/dogs') {
      ...
      let dogDetailsTemplate = fs.readFileSync('./views/dog-details.html', 'utf-8');
      let dogDetailsPage = dogDetailsTemplate
        .replace(/#{name}/g, newDog.name)
        .replace(/#{age}/g, newDog.name)
        .replace(/#{dogId}/g, newDog.Id);
